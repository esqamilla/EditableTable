...
export const SettingsIcon: FC<IconDefaultProps> = ({ className }) => {
  return (
    <svg
      className={concatClasses(className, style.icon, style.icon_settings)}
      viewBox="0 0 16 16"
      fill="none"
...
export const BackIcon: FC<IconDefaultProps> = ({ className }) => {
  return (
    <svg
      className={concatClasses(className, style.icon, style.icon_back)}
      viewBox="0 0 18 15"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
...
export const DawnIcon: FC<IconDefaultProps> = ({ className }) => {
  return (
    <svg
      className={concatClasses(className, style.icon, style.icon_dawn)}
      viewBox="0 0 12 8"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
...
export const MenuBoxesIcon: FC<IconDefaultProps> = ({ className }) => {
  return (
    <svg
      className={concatClasses(className, style.icon, style.icon_menu_boxes)}
      viewBox="0 0 18 18"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
